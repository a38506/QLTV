...
public class DataStore{
    public static List<Student> students = new ArrayList<>( Arrays.asList (
        new Student (" A1002", "Nguyen Van A", "TTh3", "Toán-tin " ),
        new Student("A1003", "Nguyen Van B", "TTh4", "Toán-tin "),
        new Student("A1004", "Nguyen Van C", "TTh3", "CNTT"),
        new Student("A1035", "Nguyen Van D", "TTh3", "Toán-tin")  
    ));
    ...
    public static List<Book> books = new ArrayList<>( Arrays.asList(
        ...
        new Book("MA110", "Kien truc may tinh", "Mask", "Toan-tin"),
        new Book("MA111", "Lap trinh huong doi tuong", "Alan", "CNTT"),
        new Book("IS111", "Mang may tinh", "Hon", "CNTT")
    ));

    public static List<BookTransaction> bookTransactions = new ArrayList<>(  Arrays.asList(
        new BookTransaction(Utils.generateID() ,"CS110" , "A1002"),
        new BookTransaction(Utils.generateID() ,"CS110" , "A1004"),
